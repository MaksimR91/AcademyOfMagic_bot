...
def handle_message(message, phone_number_id, bot_display_number, contacts):
    ...
    try:
        ...
        # ИИ не сработал, отправляем шаблон
        ...
        # если и шаблон не сработал — fallback
        send_text_message(
            phone_number_id,
            normalized_number,
