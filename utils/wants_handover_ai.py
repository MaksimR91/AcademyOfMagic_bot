...
Считай, что клиент ХОЧЕТ поговорить напрямую, только если он явно просит связаться / позвать / передать сообщение
или спрашивает телефон/контакты. Простое упоминание имени Арсений
или вопрос «кто такой Арсений?» — НЕ считается запросом.
